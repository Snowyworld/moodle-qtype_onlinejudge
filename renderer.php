...
/**
 * Online Judge question renderer class.
 *
 * @package    qtype
...
/**
 * Generate the output for online judge question.
 *
 * @copyright 2011 Hu Xue-feng <huxuefeng.cs@gmail.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_onlinejudge_renderer extends qtype_renderer {
    ...
    public function manual_comment(question_attempt $qa, question_display_options $options) {
        ...
        return html_writer::nonempty_tag('div', $question->format_text(
                $question->graderinfo, $question->graderinfo, $qa, 'qtype_onlinejudge',
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_onlinejudge_format_renderer_base extends plugin_renderer_base {
    /**
...
/**
 * An Online Judge format renderer for code where the student should use the HTML
 * editor without the file picker.
 *
 * @copyright 2011 Hu Xue-feng <huxuefeng.cs@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_onlinejudge_format_editor_renderer extends plugin_renderer_base {
    protected function class_name() {
        return 'qtype_onlinejudge_editor';
    }

    public function response_area_read_only($name, $qa, $step, $lines, $context) {
        return html_writer::tag('div', $this->prepare_response($name, $qa, $step, $context),
                array('class' => $this->class_name() . ' qtype_onlinejudge_response readonly'));
    }
    ...
    public function response_area_input($name, $qa, $step, $lines, $context) {
        ...
        $output .= html_writer::start_tag('div', array('class' =>
                $this->class_name() . ' qtype_onlinejudge_response'));
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_onlinejudge_format_editorfilepicker_renderer extends qtype_onlinejudge_format_editor_renderer {
    protected function class_name() {
        return 'qtype_onlinejudge_editorfilepicker';
    }
...
/**
 * An Online Judge format renderer for code where the student should use a plain
 * input box, but with a normal, proportional font.
 *
 * @copyright 2011 Hu Xue-feng <huxuefeng.cs@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_onlinejudge_format_plain_renderer extends plugin_renderer_base {
    /**
     * @return string the HTML for the textarea.
     */
    protected function textarea($response, $lines, $attributes) {
        $attributes['class'] = $this->class_name() . ' qtype_onlinejudge_response';
    ...
    protected function class_name() {
        return 'qtype_onlinejudge_plain';
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_onlinejudge_format_monospaced_renderer extends qtype_onlinejudge_format_plain_renderer {
    protected function class_name() {
        return 'qtype_onlinejudge_monospaced';
    }
}
